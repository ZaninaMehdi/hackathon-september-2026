              ...
              {phases.map((phase, i) => (
                <div key={i} className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    className="min-w-0 flex-1 rounded-lg border border-border bg-surface-raised px-3 py-2.5 text-sm text-ink outline-none transition-colors focus:border-accent focus:ring-2 focus:ring-accent/20"
                  />
                  <input
                    type="text"
                    inputMode="numeric"
                    ...
                    className="w-[88px] rounded-lg border border-border bg-surface-raised px-3 py-2.5 font-mono text-sm text-ink outline-none transition-colors focus:border-accent focus:ring-2 focus:ring-accent/20"
                  />
                  {phases.length > 1 && (
                    <button
                      type="button"

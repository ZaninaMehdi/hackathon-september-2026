  ...
  return (
    <button
      ...
      className={`flex w-full items-center gap-3 rounded-lg px-3.5 py-[15px] text-left ${
        selected ? "border-2 border-accent bg-accent-tint" : "border border-border bg-surface-raised"
      }`}
    >
      <span
        className={`inline-block h-[18px] w-[18px] shrink-0 rounded-full ${
          selected ? "border-[5px] border-accent bg-surface-raised" : "border-[1.5px] border-border-strong bg-surface-raised"
        }`}
      />

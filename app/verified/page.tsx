...
export default async function VerifiedExplainerPage() {
  const staff = await getStaffNav();
      ...
      <div className="flex flex-col gap-6 px-[18px] py-8">
        <div className="flex flex-col gap-3">
          ...
          <p className="text-sm leading-[1.6] text-body">
            Nothing appears on a campaign&apos;s public page until it has cleared the org&apos;s
